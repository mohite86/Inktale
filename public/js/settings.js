...
const $imageField = document.querySelector('[data-image-filed]');
 ...
 * @param {Event} event - The event representing the form submission.
 */
const updateBasicInfo = async (event) => {
    ...
    // Disable publish button to revent multiple submissions.
    ...
    // Handle case where selected image size in larger than 1MB.
